...
export const metadata = {
  ...
  description: "A representative sample of transactions completed by United Capital Partners.",
};
...
export default function TransactionsPage() {
  return (
    <>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-12">
            {transactionGroups.map(({ industry, items }) => (
              <div key={industry} style={{ borderTop: "1px solid #e8e4dc", paddingTop: "24px" }}>
                <p className="label-eyebrow mb-3">Client type</p>
                <h3 style={{ fontFamily: "'Cormorant Garamond',Georgia,serif", fontSize: "1.25rem", fontWeight: 500, color: "#111", marginBottom: "14px", lineHeight: 1.3 }}>
                  {industry}
                </h3>
                <ul style={{ fontFamily: "'Inter',sans-serif", fontSize: "0.78rem", color: "#666", lineHeight: 2, listStyle: "none", padding: 0 }}>
                  {items.map((item) => (
      ...
      <section style={{ backgroundColor: "#f8f6f2" }} className="py-20 px-8 text-center">
        <div className="max-w-xl mx-auto">
          <p className="label-eyebrow mb-4">Next steps</p>
          <h2 style={{ fontFamily: "'Cormorant Garamond',Georgia,serif", fontSize: "clamp(1.8rem,3.5vw,2.8rem)", fontWeight: 400, color: "#111", marginBottom: "16px" }}>
            Find the right solution.
          </h2>
          <p style={{ fontFamily: "'Inter',sans-serif", fontSize: "0.85rem", color: "#666", lineHeight: 1.9, marginBottom: "28px" }}>
            Every transaction is unique. Our team works closely with you to understand your capital needs and
            structure the right solution — quickly and efficiently.
          </p>
